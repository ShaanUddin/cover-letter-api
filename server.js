...
//     // *** THIS IS THE FINAL, MOST DETAILED PROMPT ***
//     const prompt = `
//         Generate a concise, professional, and tailored cover letter based on the provided resume and job description.

//         **Instructions:**
//         1.  **Create a Header:** From the resume, extract the candidate's full name, phone number, email address, and LinkedIn profile URL. Format these details as a professional header at the very top of the cover letter.
//         2.  **Write the Body:** Keep the letter under 300 words. Directly address the key requirements from the job description, using specific examples from the resume. Maintain a confident and professional tone.
//         3.  **Sign Off Correctly:** Use the extracted full name for the closing signature (e.g., "Sincerely, [Candidate's Full Name]").
...
app.post('/generate-cover-letter', upload.single('resume'), async (req, res) => {
  try {
    ...
    // *** THIS IS THE FINAL, MOST COMPLETE PROMPT ***
    const prompt = `
        Generate a concise, professional, and tailored cover letter based on the provided resume and job description.

        **Instructions:**
        1.  **Create a Professional Header:**
            * First, extract the candidate's full name, phone number, email address, and LinkedIn profile URL from the resume. Format these details as a professional header at the top.
            * Below the candidate's contact information, add today's date: **${currentDate}**.
        2.  **Write an Impactful Body:**
            * Keep the letter under 300 words.
            * Directly address the key requirements from the job description, using specific examples from the resume.
            * Maintain a confident and professional tone.
        3.  **Sign Off Correctly:**
            * Use the extracted full name for the closing signature (e.g., "Sincerely, [Candidate's Full Name]").
